...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-white selection:bg-blue-200/50 font-sans grid grid-cols-1 md:grid-cols-2 text-slate-900">
      {/* Left side: Form */}
      <div className="w-full flex items-center justify-center p-8 md:p-12 relative">
      ...
      {/* Right side: Graphic */}
      <div className="md:flex hidden bg-slate-50 border-l border-slate-100 items-center justify-center relative overflow-hidden">
